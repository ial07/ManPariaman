                        ...
                        <article class="entry" data-aos="fade-up">
                            <div class="row">
                                <div class="col-lg4 col-sm-4 col-4">
                                    <div class="entry-img">
                                        <img style="height: 300;" width="100%" class="img-fluid" src="img/berita/<?= $data['gambar'] ?>" alt="No Image" />
                                    </div>
                                </div>
                                <div class="col-lg-8 col-sm-8 col-8">
                                    ...
                                    <div class="entry-content">
                                        <p>
                                            <?= substr($data['isi_berita'], 0, 100); ?><a href="?page=pages/detail_berita&iddetail=<?php echo $data['id_berita'] ?>"> Selengkapnya...</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
